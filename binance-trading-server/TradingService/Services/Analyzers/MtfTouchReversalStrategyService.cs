...
namespace TradingTerminal.Services
{
    ...
    public class MtfTouchReversalStrategyService : StrategyBase
    {
        ...
        public MtfTouchReversalStrategyService(
        ...
        private void ExecuteTouchTrade(string symbol, bool isLong, decimal entryPrice, PendingTrigger trigger)
        {
            ...
            decimal targetRoeTp = 0.20m; // 止盈 20% ROE
            decimal riskRoeSl = 0.15m;  // 止损 15% ROE
